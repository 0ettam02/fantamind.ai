      ...
      <div className="grid grid-row-1 gap-4 place-items-center items-center md:grid-cols-3 animate-fade-right animate-duration-1000 ">
        <card className="bg-white shadow-2xl rounded-lg p-6 text-center">
          ...
          <h1 className={`${ruda.className} text-2xl md:text-4xl`}>
            La squadra<br />
            <span className='bg-[#00FF26]'>perfetta</span> è a un<br />click di distanza
          </h1>
        </card>
        <card className="bg-white shadow-2xl rounded-lg p-6 max-w-sm text-center">
          <DotLottieReact
          ...
          <h1 className={`${ruda.className} text-2xl md:text-4xl`}>
            Non più scelte<br />
            <span className='bg-[#00FF26]'>avventate</span>, solo<br />acquisti intelligenti
          </h1>
        </card>
        <card className="bg-white shadow-2xl rounded-lg p-6 max-w-sm text-center">
          <DotLottieReact
          ...
          />
          <h1 className={`${ruda.className} text-2xl md:text-4xl`}>
            Usa la <span className='bg-[#00FF26]'>statistica</span>,<br /> per trasformare le tue intuizioni<br />in <span className='bg-[#00FF26]'>vittorie</span>
          </h1>
        </card>
      </div>
    </>
