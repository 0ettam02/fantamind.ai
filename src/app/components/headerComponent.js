  ...
  return (
    <header className={`header ${ruda.className} flex flex-col items-center md:items-start md:flex-row md:ml-[5em] `}>
      <titolo className="titolo flex">
        ...
        />
        <h1Titolo className="mt-8 mb-10 text-xl md:text-3xl">fantamind.ai</h1Titolo>
      </titolo>
      <sezioneInfo className={`flex flex-col items-center  text-lg md:flex-row ${!visible ? "none" : "bg-[#00FF26] w-full md:bg-transparent md:text-black"}`}>
